...
**파일**: group_recommendation.py (model_sample/analysis/group_recommendation.py)
...
**파일**: `model_sample/moviemong/core.py` (210줄)
...
**파일**: `model_sample/moviemong/feeding.py` (138줄)
...
**파일**: `model_sample/moviemong/review.py` (130줄)
...
**파일**: `model_sample/cocktail/analyzers.py` (549줄, 5개 컴포넌트)
...
| `/api/cocktail` | POST | 감정 칵테일 생성 | `cocktail/emotion_cocktail_generator.py` |
